...
public class ScoreVO {
	...
	private String std_name, dept_name, test_date, course_name;
	...
	public ScoreVO( int stdnt_num, String stdnt_name, String dept_name, int score, String course_name) {//결과 반환
		super();
		this.score = score;
