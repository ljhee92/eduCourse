...
public class ProfessorHomeEvent extends WindowAdapter  implements ActionListener {
	private ProfessorHomeDesign pwd;
	public ProfessorHomeEvent(ProfessorHomeDesign pwd) {
		this.pwd = pwd;
