...
import eduCourse.student.event.StdntHomeEvent;

@SuppressWarnings("serial")
public class StdntHomeDesign extends JFrame {
	private LoginVO lVO;

	private JButton jbtnEnrollCour, jbtnEnrollHist, jbtnExamAttendResu, jbtnJbtnExamCorr, jbtnInfoUpda, jbtnLogout,
			jbtnSched;
	...
	public StdntHomeDesign(LoginVO lVO) {
		...
		String studPath = "src/eduCourse/image/stud/";
