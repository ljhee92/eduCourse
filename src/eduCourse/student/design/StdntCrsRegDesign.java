...
import eduCourse.student.dao.CrsRegDAO;
import eduCourse.student.event.StdntCrsRegEvent;
	...
	public void searchAllCrsReg() {
		...
		try {
			...
			for (int i = 0; i < listAllCrsRegVO.size(); i++) {
				...
				Object[] row = { crVO.getDept_name(), crVO.getCourse_name(), crVO.getCourse_code(), crVO.getLect_room(),
						crVO.getCapacity(), crVO.getCredit_hours() };
